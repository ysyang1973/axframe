...
function PeatIconStroeDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path
          d='M13 8V7H12V8H10V7H9V8H7V7H6V8H4V7H3V8H1V15H9V12C9 10.9 9.9 10 11 10C12.1 10 13 10.9 13 12V15H15V8H13ZM7 14H2V10H7V14Z'
          fill='red'
          fillOpacity='0.3'
        />
