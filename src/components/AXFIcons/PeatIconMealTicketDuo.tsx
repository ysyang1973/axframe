...
function PeatIconMealTicketDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path d='M14 7C14 6.3 14.4 5.6 15 5.3V3H12V12H15V8.7C14.4 8.4 14 7.8 14 7Z' fill='red' fillOpacity='0.3' />
        <path d='M16 13H0V14H16V13Z' fill='red' fillOpacity='0.3' />
