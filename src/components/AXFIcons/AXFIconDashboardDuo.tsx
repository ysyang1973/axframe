...
function AXFIconDashboardDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path d='M15 2H1V14H15V2Z' fill='red' fillOpacity='0.3' />
        <path
          d='M15 1H1C0.4 1 0 1.4 0 2V14C0 14.6 0.4 15 1 15H15C15.6 15 16 14.6 16 14V2C16 1.4 15.6 1 15 1ZM15 14H1V2H15V14Z'
          fill='black'
        />
