...
function AXFIconBuildingsDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path d='M11 7V2L4 4V5H7V16H11V15H15V7H11Z' fill='red' fillOpacity='0.3' />
        <path
          d='M12 6V1L10.7 1.4L3 3.6V5H0V16H16V6H12ZM1 15V6H6V15H1ZM7 15V5H4V4.3L11 2.3V4H8V5H11V6H8V7H10V8H8V9H10V10H8V11H10V15H7ZM15 15H11V7H15V15Z'
          fill='black'
        />
