...
function AXFIconLogoutDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        />
        <path
          d='M8 0C5 0 2.5 1.6 1.1 4H2.3C3.5 2.2 5.6 1 8 1C11.9 1 15 4.1 15 8C15 11.9 11.9 15 8 15C5.6 15 3.5 13.8 2.3 12H1.1C2.5 14.4 5.1 16 8 16C12.4 16 16 12.4 16 8C16 3.6 12.4 0 8 0Z'
          fill='black'
        />
      </svg>
    </AXFIconComponent>
